...
@Service
public class SocketMessengerService implements ClientMessagingService {
    ...
    public void sendMessageToUser(
            String sessionId, SocketDestinations destination, Object payload) {
    ...
    public void sendInvalidSocketMessageToUser(
        ...
        sendMessageToUser(
                user.getSocketId(), destination, buildInvalidMessageObject(code, message));
    }
