...
public class TestUtils {
    ...
    public static ResultActions getRequest(MockMvc mockMvc, String endpoint, HttpStatus expectedStatus) throws Exception {
        return getRequest(mockMvc, endpoint, new LinkedMultiValueMap<>(), expectedStatus);
    }

    public static ResultActions getRequest(MockMvc mockMvc, String endpoint, MultiValueMap<String, String> params, HttpStatus expectedStatus) throws Exception {
    ...
    public static ResultActions postRequest(MockMvc mockMvc, String endpoint, HttpStatus expectedStatus) throws Exception {
        return postRequest(mockMvc, endpoint, new LinkedMultiValueMap<>(), expectedStatus);
    }

    public static ResultActions postRequest(MockMvc mockMvc, String endpoint, MultiValueMap<String, String> params, HttpStatus expectedStatus) throws Exception {
