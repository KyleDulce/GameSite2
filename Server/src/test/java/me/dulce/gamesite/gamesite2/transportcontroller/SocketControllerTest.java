...
public class SocketControllerTest {
    ...
    public void game_success() {
        ...
        when(roomManager.doesRoomExist(any()))
                .thenReturn(true);
        when(roomManager.isUserInRoom(any(), any()))
                .thenReturn(true);
        when(roomManager.handleIncomingRoomData(any(), any()))
                .thenReturn(true);
        ...
        verify(roomManager, times(1))
                .handleIncomingRoomData(any(), any());
    }
    ...
    public void game_unauthorizedUser_authorized() {
        ...
        verify(socketMessengerService, times(1))
                .sendInvalidSocketMessageToUser(anyString(), any(), eq(HttpStatus.UNAUTHORIZED.value()), anyString());
    ...
    public void game_invalidData_badRequest() {
        ...
        verify(socketMessengerService, times(1))
                .sendInvalidSocketMessageToUser(anyString(), any(), eq(HttpStatus.BAD_REQUEST.value()), anyString());
    }
    ...
    public void game_invalidRoom_notFound() {
        ...
        verify(socketMessengerService, times(1))
                .sendInvalidSocketMessageToUser(anyString(), any(), eq(HttpStatus.NOT_FOUND.value()), anyString());
    }
    ...
    public void game_unsuccessfulHandling_returnedOkRequest() {
        ...
        verify(socketMessengerService, times(1))
                .sendInvalidSocketMessageToUser(anyString(), any(), eq(HttpStatus.OK.value()), anyString());
    }
